...
var render = function() {
  ...
  return _c("section", { staticClass: "login" }, [
    _vm._m(0),
    _vm._v(" "),
    _c("section", { staticClass: "container form" }, [
...
var actions = {
  login: function login(context, data) {
    _http__WEBPACK_IMPORTED_MODULE_0__["default"].post('/login', data).then(function (res) {
  ...
  fetchUser: function fetchUser(context) {
    _http__WEBPACK_IMPORTED_MODULE_0__["default"].get('/user').then(function (res) {
      res.json().then(function (data) {
        context.commit('setUser', data);
      });
    })["catch"](console.error);
